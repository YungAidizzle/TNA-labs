      ...
      >
        <div id="signals" className="min-h-[320px] min-w-0 xl:min-h-0 xl:overflow-hidden">
          <TerminalPanel
            ...
            disclaimer="Information only. Not personal financial advice. Narrative rankings may lag or misclassify source activity."
            action={(
        ...
        <div id="memecoins" className="min-h-[320px] min-w-0 xl:min-h-0 xl:overflow-hidden">
          <TerminalPanel
            title="Memecoins"
            subtitle="Market-linked reference table"
            tone="neutral"
            className="h-full min-h-0 min-w-0"
            bodyClassName="overflow-hidden"
            disclaimer="Reference data only. Asset links, prices, liquidity, and momentum readings may be delayed or inaccurate."
            action={(
        ...
        <div id="validation" className="min-h-[320px] min-w-0 xl:min-h-0 xl:overflow-hidden">
          <TerminalPanel
            title="Validation"
            subtitle={selectedCoin ? "Selected coin market context" : "Select a coin to review"}
            tone="emerald"
            className="h-full min-h-0 min-w-0"
            bodyClassName="overflow-hidden"
            disclaimer="Validation context only. No recommendation, solicitation, or guaranteed interpretation is provided."
            action={selectedCoin ? (
