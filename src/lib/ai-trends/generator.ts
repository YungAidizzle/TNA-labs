...
function buildGenerationPrompt(trendCount: number) {
  ...
  return [
    ...
    "Focus on internet-native culture signals: memes, viral clips, remix cycles, creator or influencer drama, fandom flashpoints, platform-native catchphrases, and crypto-native culture.",
    ...
    "Prioritize narratives that people would meme, remix, argue about, clip, quote, turn into slogans, attach identity to, or create tokens around.",
    "Strongly favor narratives with named entities, symbolic events, controversy, virality potential, cultural hooks, platform shifts, creator spillover, or retail-speculation spillover.",
    ...
    "Avoid generic world news, geopolitics, macro commentary, election process stories, and mainstream institutional coverage unless the story is clearly being meme-ified, clipped, remixed, or sloganized across internet-native communities right now.",
    ...
    "Good title style examples: Anthropic Mythos Leak, OpenAI Media Push, TikTok Audio Trend, Twitch Creator Fallout, Solana Memecoin Rotation, Clip Remix Cycle.",
    "Bad title examples to avoid: Viral Food Trend, Creator Drama, Meme Culture Shift, Platform Update Buzz, Internet Debate Topic, Middle East Escalation.",
