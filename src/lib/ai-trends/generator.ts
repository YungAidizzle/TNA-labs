...
function normalizeModelPayload(content: string, expectedTrendCount: number): GeneratedAiTrendSnapshotPayload {
  ...
  return {
    ...
    notesJson: {
      ...
      ranking_focus: "memecoin_attention_and_narrative_propagation",
    },
  };
}
...
function buildGenerationPrompt(trendCount: number) {
  ...
  return [
    ...
    "Use current web-grounded information and optimize for narratives that are most likely to influence memecoin attention through highly online culture today.",
    "This is one shared global board for all users. Do not personalize for a user segment.",
    "Focus on narratives that are meme-translatable: viral internet memes, creator or influencer moments, celebrity moments only when they become meme material, AI or deepfake meme waves, fandom flashpoints, platform-native catchphrases, animal or mascot narratives, platform drama, and crypto-native spillover that revives retail meme speculation.",
    "Strongly favor narratives that are visibly propagating on X or Twitter, Reddit, TikTok, YouTube, Telegram, Twitch, creator ecosystems, or crypto-native communities.",
    "Prioritize narratives that people would meme, remix, parody, clip, quote, turn into slogans, nickname, mascot, archetype, or token names.",
    "Strongly favor narratives with tokenization potential: named characters, animals, mascots, slogans, catchphrases, viral clips, parody edits, deepfakes, fan edits, platform drama, creator spillover, AI personas, or crypto speculation spillover.",
    "A trend only belongs high on this board if highly online communities would keep talking about it repeatedly today and it feels plausible as a memecoin narrative source.",
    "Primary ranking factor: memecoin-relevant memetic potential and narrative propagation likelihood. Secondary ranking factor: general importance.",
    "Every selected trend must be anchored to a specific current narrative object: a named person, company, product, clip, hashtag, slogan, nickname, animal, character, launch, leak, ban, platform shift, controversy, or flashpoint event.",
    ...
    "Avoid generic world news, geopolitics, macro commentary, election process stories, dry policy developments, business process news, and mainstream institutional coverage unless the story is clearly being meme-ified, clipped, remixed, sloganized, or driving crypto-speculation spillover across internet-native communities right now.",
    "Do not include a geopolitical or political story just because it is important or breaking.",
    ...
    "If a macro, political, or geopolitical story is included, it must have clear meme, creator, platform, or crypto-community spillover right now.",
    "Purely serious world events with no internet-native meme behavior should not rank.",
    "Dry crypto process news such as committee hearings, generic regulation steps, governance changes, or infrastructure updates should rank low unless they clearly reignite meme speculation or launchpad behavior.",
    "Prefer concrete current objects over broad discussion umbrellas.",
    "The final board should feel like what the memetic internet is talking about, not a generic world-news digest.",
    "Aim for roughly 30 to 45 high-relevance memecoin-translatable narratives, 30 to 45 medium-relevance spillover narratives, and no more than 25 low-relevance fallback stories.",
    ...
    "Do not generate a long title first. Do not return a long title plus a shorter variant. The title field itself must be the final stored title.",
    "Titles should usually be 5 to 12 words, can be 4 to 14 words when needed, and should stay under 140 characters.",
    "Titles must sound like clean narrative labels, not newspaper headlines or full sentences.",
    "Keep the exact subject of the trend in the title, including the specific person, company, event, slogan, meme, policy, animal, platform, clip, or object.",
    "Each title should communicate what the narrative is, what specifically is happening, and why people keep paying attention.",
    "Do not use ellipses, quotation marks, colons, semicolons, or headline-style framing in titles.",
    "Good title style examples: Grok deepfake scandal driving viral reposts and parody edits; Spot Bitcoin ETF inflows reviving crypto attention and meme speculation; TikTok US entity deal triggering creator and platform debate; Taylor Swift surprise release fueling fan-post volume and parody content.",
    "Bad title examples to avoid: AI; Politics; Creator drama; Meme culture shift; Platform update buzz; Internet debate topic; Middle East escalation.",
    ...
    "ai_rank_score should reflect memecoin-relevant narrative propagation likelihood, memetic force, and speculative-attention spillover potential.",
    "category should be a concise memecoin-aware label such as animal meme, creator viral moment, celebrity meme, platform drama, ai meme wave, fandom wave, gaming meme, crypto spillover, memeified politics, internet culture, or business.",
